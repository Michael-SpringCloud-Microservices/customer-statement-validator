package com.rbank.customer.statement.swagger.config;
...
public class SwaggerConfig {
	...
	public Docket api(){
		...
		.select().apis(RequestHandlerSelectors.basePackage("com.rbank.customer.statement.controller"))
